...
//!
//! `println!` panics when the underlying write fails, and Agent Companion's stdout is
...
//!
//! Every line Agent Companion prints goes through here instead, where nobody listening is
