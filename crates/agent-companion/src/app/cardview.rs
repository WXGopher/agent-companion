...
//!
//! Agent Companion has no resting window any more. The numbers live in the taskbar
...
pub const WINDOW_TITLE: &str = "Agent Companion Card";
...
pub struct CardView {
    ...
    /// stops opening the detail panel until Agent Companion is restarted.
