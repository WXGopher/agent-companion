...
//!
//! Hooks tell Agent Companion what is happening *now*. The transcripts under
//! `<home>/.claude/projects/**/*.jsonl` tell it what happened before Agent Companion
//! started, and cover sessions whose hooks never fired at all. Together they are
//! what makes the session list survive an Agent Companion restart.
//!
//! # Cost control
//!
