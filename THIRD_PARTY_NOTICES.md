...
Historical releases also incorporated Open Island’s notch shape and overlay
window behavior. Those components were removed when macOS became menu-bar-only.
